...
object Protein {
  ...
  implicit def deepShowInstance[Ptr[_]]: DeepShow[Protein, Ptr] = new DeepShow.FromSerialize[Protein, Ptr] {
    def serialize[M[_]](a: Protein)(implicit ev: MonadObjectOutput[M, String, Ptr]): M[Delta] =
      ev.write(a.toString)
  }
}