...
import nutcracker.{Discrete, DRef, IncSet}
...
final case class ReqGoalPhosNegInfl(agent: Protein, phosGoal: DRef[IncSet[DRef[Discrete[PhosphoTarget[DRef]]]]], phosDesc: String) extends UIRequest
